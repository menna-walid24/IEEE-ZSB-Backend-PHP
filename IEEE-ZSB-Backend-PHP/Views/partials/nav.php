    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="shrink-0">
                    <img src="https://tailwindui.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company" class="size-8" />
                </div>
                    ...
                    <?php if ($_SESSION['user'] ?? false) : ?>
                        <div class="flex items-center space-x-4">
                            ...
                            <form method="POST" action="/logout">
                                ...
                                <button type="submit" class="rounded-md bg-red-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-red-500">Log Out</button>
                            </form>
                        </div>
                    <?php else : ?>
